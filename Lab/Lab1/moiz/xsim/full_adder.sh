...
#
# Script generated by Vivado on Fri Oct 17 02:16:48 +0200 2025
...
# script info
echo -e "full_adder.sh - Script generated by export_simulation (Vivado v2025.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot full_adder xil_defaultlib.full_adder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim full_adder -key {Behavioral:sim_1:Functional:full_adder} -tclbatch cmd.tcl -protoinst "protoinst_files/FullAdder_1bit.protoinst" -log simulate.log
}
